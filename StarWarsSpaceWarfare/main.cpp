...
void Game(){
    ...
    if(!texture_normal_shot_green.loadFromFile("C:/Users/macie/Desktop/PSIO/Star Wars - Space Warfare/StarWarsSpaceWarfare/StarWarsSpaceWarfare/textures/shot_green.png")){
        std::cerr<<"blad ladowania shot_green.png"<<std::endl;
    }

    sf::Texture texture_normal_shot_red;
    if(!texture_normal_shot_red.loadFromFile("C:/Users/macie/Desktop/PSIO/Star Wars - Space Warfare/StarWarsSpaceWarfare/StarWarsSpaceWarfare/textures/shot_red.png")){
...
void MainMenu(){
    ...
    theme.play();
    theme.setVolume(0); // zmienic na 10

    sf::Font font;
    if(!font.loadFromFile("C:/Users/macie/Desktop/PSIO/Star Wars - Space Warfare/StarWarsSpaceWarfare/StarWarsSpaceWarfare/fonts/Starjedi.ttf")){
